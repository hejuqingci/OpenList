...
require (
	github.com/OpenListTeam/OpenList/v4 v4.1.3
...
replace google.golang.org/genproto/googleapis/rpc => google.golang.org/genproto/googleapis/rpc v0.0.0-20250603155806-513f23925822
